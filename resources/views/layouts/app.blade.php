...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
        <img src="msm.png"  style="" width="5%" >
        <a href="{{ url('/') }}"> <i class=" fas fa-house-user"></i></a>
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <div><a class="nav-link" href="/chat" target="_blank"> chat </a></div>
                    <div><a class="nav-link" href="store" target="_blank"> store </a></div>
